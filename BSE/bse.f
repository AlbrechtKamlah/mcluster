...
***
* See Tout et a
*l., MNRAS, 1997, 291, 732 for a description of many of the
...
*
      ...
      READ(22,*)psflag,ecflag,mdflag,kmech
      READ(22,*)pts1,pts2,pts3
      READ(22,*)disp,beta,xi,acc2,epsnov,eddfac,gamma
...
*
      ...
      text1 = 'T(Myr)  KW1 KW2  M1(M*) M2(M*) Mc1(M*) Mc2(M*)'
      text2 = 'R1(logR1/R*)   R2(logR2/R*)   R1/RL1   R2/RL2' 
      text3 = 'L1(logL/L*)     L2(logL/L*)     spin1(yr^-1)' 
      text4 = 'spin2 (yr^-1)    Mdot1(M*/yr)    Mdot2(M*/yr)' 
      text5 = 'Period(d) ecc'
      WRITE(23,'(a,a,a,a,a)')text1,text2,text3,text4,text5
      j = 0
 30   j = j + 1
