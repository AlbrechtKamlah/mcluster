...
* CCCCCCCCC Changed below! - Albrecht, 03.08.2020                              *
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
         x = min(3.d0,lhei/lbgb)
         if(abs(x-1.d0).lt.1.0d-14)then
           tau = 1.0d0
         else
...
*
*      if(rad.lt.rg)then ! ORIGINAL BSE CONDITION (Hurley et al. 2002)
      if(rad.lt.rg.or.kw.eq.0)then
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
